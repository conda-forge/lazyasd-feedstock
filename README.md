About lazyasd-feedstock
=======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/lazyasd-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/xonsh/lazyasd

Documentation: http://xon.sh/api/lazyasd.html
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4617&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/lazyasd-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `lazyasd` can be installed with `conda`:
...
```
mamba install lazyasd
```

It is possible to list all of the versions of `lazyasd` available on your platform with `conda`:
...
```
mamba search lazyasd --channel conda-forge
```
...
mamba repoquery search lazyasd --channel conda-forge

# List packages depending on `lazyasd`:
mamba repoquery whoneeds lazyasd --channel conda-forge

# List dependencies of `lazyasd`:
mamba repoquery depends lazyasd --channel conda-forge
```
